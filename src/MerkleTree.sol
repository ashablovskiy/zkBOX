...
//import "./HasherMiMC.sol"; //TO DELETE
interface Hasher {
    function MiMCSponge(
        uint256 xL_in,
        uint256 xR_in,
...
contract MerkleTree {
    ...
    uint256 public constant ZERO_VALUE = 21663839004416932945382355908790599225266501822907911457504978515578255421292; // MiMC(0)
