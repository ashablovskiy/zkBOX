...
void assesDeposit_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void assesDeposit_3_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 4429;}

uint get_number_of_components() {return 8;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 3303;}
...
assesDeposit_3_create(1,0,ctx,"main",0);
assesDeposit_3_run(0,ctx);
}
